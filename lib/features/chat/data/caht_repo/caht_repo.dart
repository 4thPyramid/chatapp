...
abstract class ChatRepo {
  ...
  Future<Either<Failure, void>> sendMessage(String chatId, String senderId, String receiverId, String text);
  ...
  Future<Either<Failure, String?>> checkIfChatExists(String currentUserId, String otherUserId);
